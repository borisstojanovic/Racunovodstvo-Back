...
class PermissionIntegrationTest extends BaseIT {
    ...
    private static final String MOCK_UID = "MOCK_UID_1";
    private static final String MOCK_EMAIL = "MOCK_EMAIL_1";
    private static final String MOCK_PASSWORD = "MOCK_PASSWORD_1";
